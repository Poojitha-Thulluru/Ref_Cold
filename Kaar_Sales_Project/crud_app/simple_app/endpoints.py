...
con_string = "mongodb+srv://poojitha:pooji@mycluster.zpewtx5.mongodb.net/?retryWrites=true&w=majority"
...
def project_api_routes(endpoints):
    ...
    def upload_file():
        ...
        future_df['predicted'] = results.predict(start = 104, end =(int(months)+104), dynamic= True)  
